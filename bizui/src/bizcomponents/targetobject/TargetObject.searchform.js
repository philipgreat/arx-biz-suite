...
import styles from './TargetObject.search.less'
...
class TargetObjectSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      targetObjectList: 1,
      'targetObjectList.searchField': fieldName,
      'targetObjectList.searchVerb': 'startsWith',
      'targetObjectList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`targetObjectList.searchField`] = fieldName
    value[`targetObjectList.searchVerb`] =  searchVerb
    value[`targetObjectList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['targetObjectList'] = 1
      params['targetObjectList.orderBy.0'] = "id"
      params['targetObjectList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        targetObjectSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(TargetObjectSearchForm)
