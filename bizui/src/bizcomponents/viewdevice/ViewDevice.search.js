...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{viewDeviceList:selectedRows}} owner={owner}  
...
class ViewDeviceSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ViewDeviceTable} = GlobalComponents;
    const {ViewDeviceSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ViewDeviceSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ViewDeviceModalTable,"viewDeviceIds")}
...
export default Form.create()(ViewDeviceSearch)
