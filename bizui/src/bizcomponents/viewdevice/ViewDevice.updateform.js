...
import styles from './ViewDevice.updateform.less'
...
class ViewDeviceUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const viewDeviceId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, viewDeviceId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateViewDevice`,
          payload: {
            id: owner.id,
            type: 'viewDevice',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextViewDeviceUpdateRow`,
        payload: {
          id: owner.id,
          type: 'viewDevice',
          selectedRows,
...
}))(Form.create()(ViewDeviceUpdateForm))
