...
import styles from './ViewDevice.search.less'
...
class ViewDeviceSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      viewDeviceList: 1,
      'viewDeviceList.searchField': fieldName,
      'viewDeviceList.searchVerb': 'startsWith',
      'viewDeviceList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`viewDeviceList.searchField`] = fieldName
    value[`viewDeviceList.searchVerb`] =  searchVerb
    value[`viewDeviceList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['viewDeviceList'] = 1
      params['viewDeviceList.orderBy.0'] = "id"
      params['viewDeviceList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        viewDeviceSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ViewDeviceSearchForm)
