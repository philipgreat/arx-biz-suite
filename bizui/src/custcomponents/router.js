...
function RouterConfig({ history }) {
	...
	const {TargetObjectBizApp} = GlobalComponents
	const {ViewDeviceBizApp} = GlobalComponents
      ...
      <Router history={history}>
        <Switch>
         ...
         <Route path="/forgetpass" component={ForgetPasswordForm} />
          ...
          <Route path="/targetObject/" component={TargetObjectBizApp} />
          <Route path="/viewDevice/" component={ViewDeviceBizApp} />
