<%@ page import='java.util.*,com.doublechaintech.arx.*,com.doublechaintech.arx.formaction.FormAction'%>
...
<sky:include page="com/doublechaintech/arx/formaction/FormAction$Summary.jsp" />
