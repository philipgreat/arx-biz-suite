<%@ page import='java.util.*,com.doublechaintech.arx.*,com.doublechaintech.arx.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/arx/userwhitelist/UserWhiteList$Summary.jsp" />
