<%@ page import='java.util.*,com.doublechaintech.arx.*,com.doublechaintech.arx.userapp.UserApp'%>
...
<sky:include page="com/doublechaintech/arx/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/doublechaintech/arx/secuser/SecUser$Info.jsp" />
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/arx/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/arx/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
