<%@ page import='java.util.*,com.doublechaintech.arx.*,com.doublechaintech.arx.formfield.FormField'%>
...
<sky:include page="com/doublechaintech/arx/formfield/FormField$Summary.jsp" />
