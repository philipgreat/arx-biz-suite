<%@ page import='java.util.*,com.doublechaintech.arx.*,com.doublechaintech.arx.secuser.SecUser'%>
...
<sky:include page="com/doublechaintech/arx/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/doublechaintech/arx/userdomain/UserDomain$Info.jsp" />
...
<sky:include page="com/doublechaintech/arx/secuserblocking/SecUserBlocking$Action.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/arx/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/arx/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
