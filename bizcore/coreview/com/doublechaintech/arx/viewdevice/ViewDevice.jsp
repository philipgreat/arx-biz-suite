<%@ page import='java.util.*,com.doublechaintech.arx.*,com.doublechaintech.arx.viewdevice.ViewDevice'%>
...
<c:set var="ownerBeanName" value="viewDevice" scope="request"/>
<c:set var="ownerClassName" value="ViewDevice" scope="request"/>
...
<div class="row">
	...
	<% ViewDevice result = (ViewDevice)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="viewDevice" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/arx/viewdevice/ViewDevice$Summary.jsp" />
