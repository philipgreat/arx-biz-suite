<%@ page import='java.util.*,com.doublechaintech.arx.*,com.doublechaintech.arx.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/arx/formmessage/FormMessage$Summary.jsp" />
