<%@ page import='java.util.*,com.doublechaintech.arx.*,com.doublechaintech.arx.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/arx/loginhistory/LoginHistory$Summary.jsp" />
