<%@ page import='java.util.*,com.doublechaintech.arx.*,com.doublechaintech.arx.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/arx/listaccess/ListAccess$Summary.jsp" />
