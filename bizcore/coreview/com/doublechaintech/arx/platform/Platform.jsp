<%@ page import='java.util.*,com.doublechaintech.arx.*,com.doublechaintech.arx.platform.Platform'%>
...
<sky:include page="com/doublechaintech/arx/platform/Platform$Summary.jsp" />
		...
		<div id="viewDeviceList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/arx/viewdevice/ViewDevice$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
