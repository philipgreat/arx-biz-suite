<%@ page import='java.util.*,com.doublechaintech.arx.*,com.doublechaintech.arx.targetobject.TargetObject'%>
...
<c:set var="ownerBeanName" value="targetObject" scope="request"/>
<c:set var="ownerClassName" value="TargetObject" scope="request"/>
...
<div class="row">
	...
	<% TargetObject result = (TargetObject)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="targetObject" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/arx/targetobject/TargetObject$Summary.jsp" />
