<%@ page import='java.util.*,com.doublechaintech.arx.*,com.doublechaintech.arx.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechaintech/arx/secuserblocking/SecUserBlocking$Summary.jsp" />
