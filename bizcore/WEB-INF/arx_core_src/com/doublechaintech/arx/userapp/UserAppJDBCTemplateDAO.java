...
public class UserAppJDBCTemplateDAO extends ArxNamingServiceDAO implements UserAppDAO{
	...
	*/
    ...
    public SmartList<UserApp> requestCandidateUserAppForListAccess(ArxUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<UserApp> requestCandidateUserAppForObjectAccess(ArxUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(UserAppTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getUserAppMapper());
    }
	...
	public void loadOurListAccessList(ArxUserContext userContext, List<UserApp> us, Map<String,Object> options) throws Exception{
	...
	public void loadOurObjectAccessList(ArxUserContext userContext, List<UserApp> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return;
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
