...
public class BaseForm extends GenericForm{
	...
	protected FormField idFromTargetObject(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("ID");
		field.setLocaleKey("target_object.id");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField nameFromTargetObject(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("名称");
		field.setLocaleKey("target_object.name");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField longitudeFromTargetObject(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("经度");
		field.setLocaleKey("target_object.longitude");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
	...
	protected FormField latitudeFromTargetObject(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("纬度");
		field.setLocaleKey("target_object.latitude");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("number");
	...
	protected FormField heightFromTargetObject(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("高度");
		field.setLocaleKey("target_object.height");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("number");
		field.setRequired(true);
		field.setPlaceholder("请填写高度");
		return field;
	}

	protected FormField textContentFromTargetObject(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("文本内容");
		field.setLocaleKey("target_object.text_content");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
		field.setRequired(true);
		field.setPlaceholder("请填写文本内容");
		return field;
	}

	protected FormField imagePathFromTargetObject(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("图片路径");
		field.setLocaleKey("target_object.image_path");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("image");
	...
	protected FormField idFromViewDevice(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("ID");
		field.setLocaleKey("view_device.id");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField nameFromViewDevice(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("名称");
		field.setLocaleKey("view_device.name");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField longitudeFromViewDevice(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("经度");
		field.setLocaleKey("view_device.longitude");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("number");
	...
	protected FormField latitudeFromViewDevice(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("纬度");
		field.setLocaleKey("view_device.latitude");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("number");
	...
	protected FormField heightFromViewDevice(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("高度");
		field.setLocaleKey("view_device.height");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("number");
	...
	protected FormField platformIdFromViewDevice(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("平台");
		field.setLocaleKey("view_device.platform");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("Platform");
