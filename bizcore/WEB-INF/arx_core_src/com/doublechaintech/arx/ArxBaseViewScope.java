...
public class ArxBaseViewScope {
	...
	protected static SerializeScope TargetObjectBaseSummaryScope = SerializeScope.INCLUDE()
		.field(TargetObject.ID_PROPERTY)
		.field(TargetObject.NAME_PROPERTY)
		.field(TargetObject.LONGITUDE_PROPERTY)
		.field(TargetObject.LATITUDE_PROPERTY)
	...
	public static SerializeScope getTargetObjectSummaryScope() {
		return TargetObjectBaseSummaryScope;
	}

	protected static SerializeScope ViewDeviceBaseSummaryScope = SerializeScope.INCLUDE()
		.field(ViewDevice.ID_PROPERTY)
		.field(ViewDevice.NAME_PROPERTY)
	...
	public static SerializeScope getViewDeviceSummaryScope() {
		return ViewDeviceBaseSummaryScope;
	}
	...
	protected static SerializeScope TargetObjectBaseSecondaryListItemScope = SerializeScope.INCLUDE()
		.field(TargetObject.ID_PROPERTY)
		.field(TargetObject.NAME_PROPERTY)
		.field(TargetObject.LONGITUDE_PROPERTY)
		.field(TargetObject.LATITUDE_PROPERTY)
	...
	public static SerializeScope getTargetObjectSecondaryListItemScope() {
		return TargetObjectBaseSecondaryListItemScope;
	}

	protected static SerializeScope ViewDeviceBaseSecondaryListItemScope = SerializeScope.INCLUDE()
		.field(ViewDevice.ID_PROPERTY)
		.field(ViewDevice.NAME_PROPERTY)
		.field(ViewDevice.LONGITUDE_PROPERTY)
		.field(ViewDevice.LATITUDE_PROPERTY)
	...
	public static SerializeScope getViewDeviceSecondaryListItemScope() {
		return ViewDeviceBaseSecondaryListItemScope;
	}
	...
	protected static SerializeScope TargetObjectBaseListItemScope = SerializeScope.INCLUDE()
		.field(TargetObject.ID_PROPERTY)
		.field(TargetObject.NAME_PROPERTY)
		.field(TargetObject.LONGITUDE_PROPERTY)
		.field(TargetObject.LATITUDE_PROPERTY)
	...
	public static SerializeScope getTargetObjectListItemScope() {
		return TargetObjectBaseListItemScope;
	}

	protected static SerializeScope ViewDeviceBaseListItemScope = SerializeScope.INCLUDE()
		.field(ViewDevice.ID_PROPERTY)
		.field(ViewDevice.NAME_PROPERTY)
		.field(ViewDevice.LONGITUDE_PROPERTY)
		.field(ViewDevice.LATITUDE_PROPERTY)
	...
	public static SerializeScope getViewDeviceListItemScope() {
		return ViewDeviceBaseListItemScope;
	}
	...
	protected static SerializeScope TargetObjectBaseDetailScope = SerializeScope.INCLUDE()
		.field(TargetObject.ID_PROPERTY)
		.field(TargetObject.NAME_PROPERTY)
		.field(TargetObject.LONGITUDE_PROPERTY)
		.field(TargetObject.LATITUDE_PROPERTY)
	...
	public static SerializeScope getTargetObjectDetailScope() {
		return TargetObjectBaseDetailScope;
	}

	protected static SerializeScope ViewDeviceBaseDetailScope = SerializeScope.INCLUDE()
		.field(ViewDevice.ID_PROPERTY)
		.field(ViewDevice.NAME_PROPERTY)
		.field(ViewDevice.LONGITUDE_PROPERTY)
		.field(ViewDevice.LATITUDE_PROPERTY)
	...
	public static SerializeScope getViewDeviceDetailScope() {
		return ViewDeviceBaseDetailScope;
	}
