...
public class ArxBaseUtils {
	...
	protected static BaseEntity loadCanCacheInLocal(ArxUserContext userContext, String type, String id) throws Exception {
	...
	public static <T extends BaseEntity> List<T> collectReferencedObjectWithType(ArxUserContext userContext,
	...
	private static <T extends BaseEntity> void collectReferedObjectIdSet(ArxUserContext userContext,
	...
	public static int getAppBuildVersion(ArxUserContext ctx) {
     ...
     * "x-app-version" : "9"
	 */
	public static String getRequestAppVersion(ArxUserContext userContext) {
		return userContext.getRequestHeader("x-app-version");
	}
	public static String getRequestAppDevice(ArxUserContext userContext) {
		return userContext.getRequestHeader("x-app-device");
	}
	public static String getRequestAppType(ArxUserContext userContext) {
