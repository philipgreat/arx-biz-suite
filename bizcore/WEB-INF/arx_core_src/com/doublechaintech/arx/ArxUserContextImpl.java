...
import com.doublechaintech.arx.secuser.SecUserCustomManagerImpl;
...
public class ArxUserContextImpl extends UserContextImpl implements ArxUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.arx.ArxResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.arx.ArxCustomResources";
    ...
    /*
    public static SecUser getSecUser(ArxUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(ArxUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(ArxUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(ArxUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
