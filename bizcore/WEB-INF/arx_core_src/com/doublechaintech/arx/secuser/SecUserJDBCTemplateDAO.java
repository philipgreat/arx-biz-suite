...
public class SecUserJDBCTemplateDAO extends ArxNamingServiceDAO implements SecUserDAO{
	...
	*/
    ...
    public SmartList<SecUser> requestCandidateSecUserForUserApp(ArxUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<SecUser> requestCandidateSecUserForLoginHistory(ArxUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(SecUserTable.COLUMN_LOGIN, filterKey, pageNo, pageSize, getSecUserMapper());
    }
	...
	public void loadOurUserAppList(ArxUserContext userContext, List<SecUser> us, Map<String,Object> options) throws Exception{
	...
	public void loadOurLoginHistoryList(ArxUserContext userContext, List<SecUser> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return;
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
