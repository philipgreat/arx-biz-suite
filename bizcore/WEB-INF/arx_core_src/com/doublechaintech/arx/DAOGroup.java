...
import com.doublechaintech.arx.platform.PlatformTokens;
import com.doublechaintech.arx.targetobject.TargetObject;
import com.doublechaintech.arx.targetobject.TargetObjectDAO;
import com.doublechaintech.arx.targetobject.TargetObjectTokens;
import com.doublechaintech.arx.viewdevice.ViewDevice;
import com.doublechaintech.arx.viewdevice.ViewDeviceDAO;
import com.doublechaintech.arx.viewdevice.ViewDeviceTokens;
import com.doublechaintech.arx.userdomain.UserDomain;
import com.doublechaintech.arx.userdomain.UserDomainDAO;
import com.doublechaintech.arx.userdomain.UserDomainTokens;
import com.doublechaintech.arx.userwhitelist.UserWhiteList;
import com.doublechaintech.arx.userwhitelist.UserWhiteListDAO;
import com.doublechaintech.arx.userwhitelist.UserWhiteListTokens;
import com.doublechaintech.arx.secuser.SecUser;
import com.doublechaintech.arx.secuser.SecUserDAO;
import com.doublechaintech.arx.secuser.SecUserTokens;
import com.doublechaintech.arx.secuserblocking.SecUserBlocking;
import com.doublechaintech.arx.secuserblocking.SecUserBlockingDAO;
import com.doublechaintech.arx.secuserblocking.SecUserBlockingTokens;
import com.doublechaintech.arx.userapp.UserApp;
import com.doublechaintech.arx.userapp.UserAppDAO;
import com.doublechaintech.arx.userapp.UserAppTokens;
import com.doublechaintech.arx.listaccess.ListAccess;
import com.doublechaintech.arx.listaccess.ListAccessDAO;
import com.doublechaintech.arx.listaccess.ListAccessTokens;
import com.doublechaintech.arx.objectaccess.ObjectAccess;
import com.doublechaintech.arx.objectaccess.ObjectAccessDAO;
import com.doublechaintech.arx.objectaccess.ObjectAccessTokens;
import com.doublechaintech.arx.loginhistory.LoginHistory;
import com.doublechaintech.arx.loginhistory.LoginHistoryDAO;
import com.doublechaintech.arx.loginhistory.LoginHistoryTokens;
import com.doublechaintech.arx.genericform.GenericForm;
import com.doublechaintech.arx.genericform.GenericFormDAO;
import com.doublechaintech.arx.genericform.GenericFormTokens;
import com.doublechaintech.arx.formmessage.FormMessage;
import com.doublechaintech.arx.formmessage.FormMessageDAO;
import com.doublechaintech.arx.formmessage.FormMessageTokens;
import com.doublechaintech.arx.formfieldmessage.FormFieldMessage;
import com.doublechaintech.arx.formfieldmessage.FormFieldMessageDAO;
import com.doublechaintech.arx.formfieldmessage.FormFieldMessageTokens;
import com.doublechaintech.arx.formfield.FormField;
import com.doublechaintech.arx.formfield.FormFieldDAO;
import com.doublechaintech.arx.formfield.FormFieldTokens;
import com.doublechaintech.arx.formaction.FormAction;
import com.doublechaintech.arx.formaction.FormActionDAO;
import com.doublechaintech.arx.formaction.FormActionTokens;

public class DAOGroup {

	protected PlatformDAO platformDAO;

	protected TargetObjectDAO targetObjectDAO;

	protected ViewDeviceDAO viewDeviceDAO;
	...
	public void setTargetObjectDAO(TargetObjectDAO dao){
		this.targetObjectDAO = dao;
	}
	...
	public void setViewDeviceDAO(ViewDeviceDAO dao){
		this.viewDeviceDAO = dao;
	}
	...
	static {
		...
		internalLoaderMap.put("TargetObject", new BasicLoader() {
			@Override
			public BaseEntity loadBasicData(DAOGroup daoGoup, String id) throws Exception {
				return daoGoup.getTargetObjectDAO().load(id, TargetObjectTokens.withoutLists());
			}
			@Override
			public BaseEntity loadBasicDataWithToken(DAOGroup daoGoup, String id, Map<String, Object> tokens) throws Exception {
				return daoGoup.getTargetObjectDAO().load(id, tokens);
			}
			@Override
			public BaseEntity present(DAOGroup daoGoup, BaseEntity data, Map<String, Object> tokens) throws Exception {
				return daoGoup.getTargetObjectDAO().present((TargetObject)data, tokens);
			}
		});

		internalLoaderMap.put("ViewDevice", new BasicLoader() {
			@Override
			public BaseEntity loadBasicData(DAOGroup daoGoup, String id) throws Exception {
				return daoGoup.getViewDeviceDAO().load(id, ViewDeviceTokens.withoutLists());
			}
			@Override
			public BaseEntity loadBasicDataWithToken(DAOGroup daoGoup, String id, Map<String, Object> tokens) throws Exception {
				return daoGoup.getViewDeviceDAO().load(id, tokens);
			}
			@Override
			public BaseEntity present(DAOGroup daoGoup, BaseEntity data, Map<String, Object> tokens) throws Exception {
				return daoGoup.getViewDeviceDAO().present((ViewDevice)data, tokens);
			}
		});
