...
public class GenericFormJDBCTemplateDAO extends ArxNamingServiceDAO implements GenericFormDAO{
	...
	*/
    ...
    public SmartList<GenericForm> requestCandidateGenericFormForFormMessage(ArxUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<GenericForm> requestCandidateGenericFormForFormFieldMessage(ArxUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
		
    public SmartList<GenericForm> requestCandidateGenericFormForFormField(ArxUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
		
    public SmartList<GenericForm> requestCandidateGenericFormForFormAction(ArxUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
	...
	public void loadOurFormMessageList(ArxUserContext userContext, List<GenericForm> us, Map<String,Object> options) throws Exception{
	...
	public void loadOurFormFieldMessageList(ArxUserContext userContext, List<GenericForm> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return;
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
	...
	public void loadOurFormFieldList(ArxUserContext userContext, List<GenericForm> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return;
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
	...
	public void loadOurFormActionList(ArxUserContext userContext, List<GenericForm> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return;
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
