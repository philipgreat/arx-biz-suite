...
public class SecUserBlockingJDBCTemplateDAO extends ArxNamingServiceDAO implements SecUserBlockingDAO{
	...
	*/
    ...
    public SmartList<SecUserBlocking> requestCandidateSecUserBlockingForSecUser(ArxUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public void loadOurSecUserList(ArxUserContext userContext, List<SecUserBlocking> us, Map<String,Object> options) throws Exception{
