...
@JsonSerialize(using = ArxExceptionJsonSerializer.class)
public class ArxException extends Exception implements MessageContainer {
    ...
    public ArxException(String message) {
        super(message);
    }
    public ArxException(Message message) {
    	super();
        this.addErrorMessage(message);
    }
	public ArxException(List<Message> messageList) {
        super();
    ...
    public ArxException(String message, Throwable cause) {
        super(message, cause);
    }


    public ArxException(Throwable cause) {
        super(cause);
    }
