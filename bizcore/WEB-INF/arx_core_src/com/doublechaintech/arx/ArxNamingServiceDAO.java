...
public class ArxNamingServiceDAO extends CommonJDBCTemplateDAO {
	...
	static {
		...
		namingTableMap.put("TargetObject", new String[]{"target_object_data","name"});
		namingTableMap.put("ViewDevice", new String[]{"view_device_data","name"});
