...
import com.doublechaintech.arx.ArxUserContextImpl;
import com.doublechaintech.arx.LoginForm;
import com.doublechaintech.arx.BaseEntity;
import com.doublechaintech.arx.CommonError;
import com.doublechaintech.arx.DAOGroup;
import com.doublechaintech.arx.ManagerGroup;

import com.doublechaintech.arx.UserContextImpl;
import com.doublechaintech.arx.userapp.UserApp;
import com.doublechaintech.arx.ArxUserContext;
import com.doublechaintech.arx.userapp.*;
import com.doublechaintech.arx.listaccess.*;
import com.doublechaintech.arx.objectaccess.*;
import com.doublechaintech.arx.ArxChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(ArxUserContext userContext){
    ...
    public Object resetPassword(ArxUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(ArxUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(ArxUserContext userContext,
    ...
    public SecUser manage(ArxUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(ArxUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(ArxUserContext userContext) {
    ...
    protected Object gotoApp(ArxUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(ArxUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(ArxUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(ArxUserContext userContex, int length){
    ...
    protected String getBeanName(ArxUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(ArxUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(ArxUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(ArxUserContext userContext, UserApp app){
    ...
    public Object home(ArxUserContext userContext) {
    ...
    public Object loginWithEmail(ArxUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(ArxUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(ArxUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(ArxUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(ArxUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(ArxUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(ArxUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(ArxUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(ArxUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        ArxUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected ArxChecker checker;
    public ArxChecker getChecker(){
        return checker;
    }
    
    public void setChecker(ArxChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((ArxChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected ArxUserContextImpl createNewConext(String path) {

        return new ArxUserContextImpl();
    ...
    public Object checkOtherLogin(ArxUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(ArxUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(ArxUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(ArxUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(ArxUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(ArxUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(ArxUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
